...
const InteractiveDataTable = ({ 
  ...
  const columns = [
    ...
    { key: 'social_networks.Facebook.engagement', label: 'Facebook vistas media/video', network: 'Facebook' },
    ...
    { key: 'social_networks.X.engagement', label: 'X vistas media/video', network: 'X' },
    ...
    { key: 'social_networks.Instagram.engagement', label: 'Instagram vistas media/video', network: 'Instagram' },
    ...
    { key: 'social_networks.YouTube.engagement', label: 'YouTube vistas media/video', network: 'YouTube' },
    ...
    { key: 'social_networks.TikTok.engagement', label: 'TikTok vistas media/video', network: 'TikTok' },
  ];
