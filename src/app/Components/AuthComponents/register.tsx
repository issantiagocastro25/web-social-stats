        ...
        <>
            <Card className="max-w-lg mx-auto p-6 shadow-md bg-white">
                <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
                    ...
                    <div className="col-span-full">
                        <label htmlFor="phone" className="block text-sm font-medium leading-6 text-gray-900">Número de teléfono</label>
                        <div className="mt-2">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Label htmlFor="terms" className="text-sm font-light">
                            Acepta los <span className="text-cyan-500 cursor-pointer" onClick={() => setShowModal(true)}>términos y condiciones</span>
                        </Label>
                    </div>
